...
public final class BarUtils {
     ...
     */
    public static void setStatusBarColor4Drawer(Context context, @NonNull final Activity activity,
     ...
     * @param isTop         True to set DrawerLayout at the top layer, false otherwise.
     */
    public static void setStatusBarAlpha4Drawer(Context context, @NonNull final Activity activity,
                                                @NonNull final DrawerLayout drawer,
                                                @NonNull final View fakeStatusBar,
                                                final boolean isTop) {
    ...
    public static void setBarColorWithToolbar(){
