...
import com.qflbai.lib.base.LibBaseApplication;
        ...
        public void onReceiveLocation(BDLocation location) {
            if (null != location && location.getLocType() != BDLocation.TypeServerError) {
               ...
               // Log.w(TAG,sb.toString());
                ...
                LocationInfoUtil.savaLAddress(location.getLatitude() + "", location.getLongitude() + "", location.getRadius() + "", location.getCountryCode(),
                ...
                if (location.getAddress()!=null&&(!location.getAddress().address.isEmpty())){
                    stop();
                }
